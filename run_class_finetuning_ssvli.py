...
from dataset_ssvli import build_finetuning_dataset_ssvli
from engine_for_finetuning_ssvli import train_one_epoch, validation_one_epoch, final_test, merge
...
def get_args():
    ...
    parser.add_argument('--early_stopping_patience', default=100, type=int, help='early stopping patience')


    # Dataset parameters99
    parser.add_argument('--data_path', default='/home/mona/SSVLI/dataset/epic_kitchens/', type=str,
                        help='dataset path')
    parser.add_argument('--eval_data_path', default='/home/mona/SSVLI/dataset/epic_kitchens/annotation/verb/val.csv', type=str,
                        help='dataset path for evaluation')
    parser.add_argument('--nb_classes', default=35, type=int,
                        help='number of the classification types')#3806
    ...
    parser.add_argument('--seed', default=10, type=int)#10
    ...
    parser.add_argument('--enable_deepspeed', action='store_true', default=False) #True
...
def seed_everything(seed=10):#10
    random.seed(seed)
...
def main(args, ds_init):
    ...
    dataset_train, args.nb_classes = build_finetuning_dataset_ssvli(is_train=True, test_mode=False, args=args)
    if args.disable_eval_during_finetuning:
        dataset_val = None
    else:
        dataset_val, _ = build_finetuning_dataset_ssvli(is_train=False, test_mode=False, args=args)
    dataset_test, _ = build_finetuning_dataset_ssvli(is_train=False, test_mode=True, args=args)
