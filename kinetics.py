...
class VideoMAE_ssvli(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.transform = transform
        self.lazy_init = lazy_init
        self.video_text = torch.load('../../home/welles/scratch/datasets/SSVLI/EPIC_100_train_noun_text.pt')
    ...
    def __getitem__(self, index):
        ...
        return (process_data, video_text, mask)
...
class VideoMAE_BB(torch.utils.data.Dataset):
    """Load your own video classification dataset.
    Parameters
    ----------
    root : str, required.
    ...
    def __init__(self,
        ...
        super(VideoMAE_BB, self).__init__()
        self.root = root
        self.setting = setting
        self.train = train
        self.test_mode = test_mode
...
# we don't want to have a specific global uninion BB through the video. We want to only have union for each frame! 
class VideoMAE_BB_no_global_union(torch.utils.data.Dataset):
    """Load your own video classification dataset.
    Parameters
    ----------
    root : str, required.
    ...
    def __init__(self,
        ...
        super(VideoMAE_BB_no_global_union, self).__init__()
        self.root = root
        self.setting = setting
        self.train = train
        self.test_mode = test_mode
